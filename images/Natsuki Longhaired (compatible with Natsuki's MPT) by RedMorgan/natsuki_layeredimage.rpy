...
layeredimage natsuki turned:
    ...
    group left: #Left arm.
        ...
        yoffset (-0.5)
        attribute ldown default if_all(["uniform","ff"]):
            "mod_assets/MPT/natsuki/natsuki_turned_uniform_left_down.png"
        attribute ldown default if_all(["casual","ff"]):
            "mod_assets/MPT/natsuki/natsuki_turned_casual_left_down.png"
        attribute lhip if_all(["uniform","ff"]):
            "mod_assets/MPT/natsuki/natsuki_turned_uniform_left_hip.png"
        attribute lhip if_all(["casual","ff"]):
            "mod_assets/MPT/natsuki/natsuki_turned_casual_left_hip.png"

        attribute ldown default if_all(["uniform","ffl"]):
            "mod_assets/MPT/natsuki/long/natsuki_turned(ff)_uniform_left_down_long.png"
        attribute ldown default if_all(["casual","ffl"]):
            "mod_assets/MPT/natsuki/long/natsuki_turned(ff)_casual_left_down_long.png"
        attribute lhip if_all(["uniform","ffl"]):
            "mod_assets/MPT/natsuki/long/natsuki_turned(ff)_uniform_left_hip_long.png"
        attribute lhip if_all(["casual","ffl"]):
            "mod_assets/MPT/natsuki/long/natsuki_turned(ff)_casual_left_hip_long.png"

        attribute ldown default if_all(["uniform","fsl"]):
            "mod_assets/MPT/natsuki/long/natsuki_turned(fs)_uniform_left_down_long.png"
        attribute ldown default if_all(["casual","fsl"]):
            "mod_assets/MPT/natsuki/long/natsuki_turned(fs)_casual_left_down_long.png"
        attribute lhip if_all(["uniform","fsl"]):
            "mod_assets/MPT/natsuki/long/natsuki_turned(fs)_uniform_left_hip_long.png"
        attribute lhip if_all(["casual","fsl"]):
            "mod_assets/MPT/natsuki/long/natsuki_turned(fs)_casual_left_hip_long.png"
    ...
    group right: #right half of her body.
        anchor (0,0) subpixel (True)
        yoffset (-0.5)
        attribute rdown default if_all(["uniform","ff"]):
            "mod_assets/MPT/natsuki/natsuki_turned_uniform_right_down.png"
        attribute rdown default if_all(["casual","ff"]):
            "mod_assets/MPT/natsuki/natsuki_turned_casual_right_down.png"
        attribute rhip if_all(["uniform","ff"]):
            "mod_assets/MPT/natsuki/natsuki_turned_uniform_right_hip.png"
        attribute rhip if_all(["casual","ff"]):
            "mod_assets/MPT/natsuki/natsuki_turned_casual_right_hip.png"

        attribute rdown default if_all(["uniform","ffl"]):
            "mod_assets/MPT/natsuki/long/natsuki_turned(ff)_uniform_right_down_long.png"
        attribute rdown default if_all(["casual","ffl"]):
            "mod_assets/MPT/natsuki/long/natsuki_turned(ff)_casual_right_down_long.png"
        attribute rhip if_all(["uniform","ffl"]):
            "mod_assets/MPT/natsuki/long/natsuki_turned(ff)_uniform_right_hip_long.png"
        attribute rhip if_all(["casual","ffl"]):
            "mod_assets/MPT/natsuki/long/natsuki_turned(ff)_casual_right_hip_long.png"

        attribute rdown default if_all(["uniform","fsl"]):
            "mod_assets/MPT/natsuki/long/natsuki_turned(fs)_uniform_right_down_long.png"
        attribute rdown default if_all(["casual","fsl"]):
            "mod_assets/MPT/natsuki/long/natsuki_turned(fs)_casual_right_down_long.png"
        attribute rhip if_all(["uniform","fsl"]):
            "mod_assets/MPT/natsuki/long/natsuki_turned(fs)_uniform_right_hip_long.png"
        attribute rhip if_all(["casual","fsl"]):
            "mod_assets/MPT/natsuki/long/natsuki_turned(fs)_casual_right_hip_long.png"
    ...
    group head: #This needs to render above her body for her "turned" pose.
        ...
        attribute ffl:
            "mod_assets/MPT/natsuki/long/natsuki_face_forward_long.png"  

        attribute fsl:
            "mod_assets/MPT/natsuki/long/natsuki_face_sad_long.png"
    ...
    group nose if_any(["ff","ffl"]) if_not(["fta","fs","fsl"]):
    ...
    group mouth if_any(["ff","ffl"]) if_not(["fta","fs","fsl"]):
    ...
    group eyes if_any(["ff","ffl"]) if_not(["fta","fs","fsl"]):
    ...
    group eyebrows if_any(["ff","ffl"]) if_not(["fta","fs","fsl"]): #eyebrows.
    ...
    group eyebrows:#In case you're wondering why there's no if_all or if_not logic on this group line, it's because the attributes below explicitly use the same logic - and if you have a group and an attribute both using the same logic tag, the attribute one will COMPLETELY overwrite and ignore the group logic.  It took me way too long to figure this out.
        ...
        attribute brow default if_any(["vang"]) if_all(["ff","ffl","oe"]) if_not(["fta","fs","fsl","ce"]):
            "nat_ff_b1d"
        attribute brow default if_any(["vang"]) if_all(["ce","ff","ffl"]) if_not(["fta","fs","fsl","oe"]):
            "nat_ff_b3a"
        attribute brow default if_any(["laug"]) if_all(["ff","ffl","oe"]) if_not(["fta","fs","fsl","ce"]):
            "nat_ff_b1b"
        attribute brow default if_any(["laug"]) if_all(["ce","ff","ffl"]) if_not(["fta","fs","fsl","oe"]):
            "nat_ff_b3a"
        attribute brow default if_any(["yand"]) if_all(["ff","ffl","oe"]) if_not(["fta","fs","fsl","ce"]):
            "nat_ff_b2a"
        attribute brow default if_any(["yand"]) if_all(["ce","ff","ffl"]) if_not(["fta","fs","fsl"]):
            "nat_ff_b3c"
        attribute brow default if_any(["anno","angr"]) if_all(["ff","ffl","oe"]) if_not(["fta","fs","fsl","ce"]):
            "nat_ff_b1d"
        attribute brow default if_any(["anno","angr"]) if_all(["ce","ff","ffl"]) if_not(["fta","fs","fsl"]):
            "nat_ff_b3b"



    group eyebrows if_any(["ff","ffl"]) if_not(["fta","fs","fsl"]):
    ...
    group special if_any(["ff","ffl"]) if_not(["fta","fs","fsl"]):
...
####################The "sad, turned away" face, and the few expressions it has.
    ...
    group nose if_any(["fs","fsl"]) if_not(["ff","ffl","fta"]):
    ...
    group mouth if_any(["fs","fsl"]) if_not(["ff","ffl","fta"]):
    ...
    group eyes if_any(["fs","fsl"]) if_not(["ff","ffl","fta","n5","bful"]): #Cannot show if full-face blush is present.
    ...
    group eyebrows if_any(["fs","fsl"]) if_not(["ff","ffl","fta","n5","bful"]): #Cannot show if full-face blush is present.
    ...
    group eyebrows:#Required separate group definition because of additional logic for showing these particular eyebrows.
        ...
        attribute brow default if_any(["cry"]) if_all(["fs","fsl","oe"]) if_not(["ff","ffl","fta","n5","bful","ce"]):
            "nat_fs_b3"
        attribute brow default if_any(["cry"]) if_all(["fs","fsl","ce"]) if_not(["ff","ffl","fta","n5","bful","oe"]):
            "nat_fs_b2"
...
layeredimage natsuki cross:
    ...
    group head: #This needs to render below her body for her "cross" pose.
        ...
        attribute ffl:
            "mod_assets/MPT/natsuki/long/natsuki_face_crossed_long.png"  
    ...
    always:
        "mod_assets/MPT/natsuki/long/natsuki_crossed(ff)_uniform_long.png" if_all(["uniform","ffl"])
    always:
        "mod_assets/MPT/natsuki/long/natsuki_crossed(fs)_uniform_long.png" if_all(["uniform"]) if_any(["fsl","fta"])
    always:
        "mod_assets/MPT/natsuki/long/natsuki_crossed(ff)_casual_long.png" if_all(["casual","ffl"])
    always:
        "mod_assets/MPT/natsuki/long/natsuki_crossed(fs)_casual_long.png" if_all(["casual"]) if_any(["fsl","fta"])
